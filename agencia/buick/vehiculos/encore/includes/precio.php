...
<body>
    <div class="position-relative">
        <img src="../imgs-2025/gm-buick-mov-encore-precio-mh-lg.avif" class="img-fluid w-100" style="max-height: 90vh; object-fit: cover;" alt="Portada envista">
    </div>
    ...
    <div class="container my-5">
        <div class="row equal-height-row">
            <div class="col-lg-6 d-flex align-items-start flex-column">
                <img src="../imgs-2025/colores/avenir/jinx.avif" class="img-fluid img-vehicle" alt="Jinx Avenir">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-label="PRECIO DE LISTA *">$713,100</td>
                        <td data-label="PRECIO DE CONTADO">$713,100</td>
                        <td data-label="PRECIO FINANCIADO *">$713,100</td>
                        <td data-label="PRECIO DE LEASING *">$713,100</td>
                    </tr>
                    <tr>
                        <td data-label="PAQUETES">Avenir</td>
                        <td data-label="PRECIO DE LISTA *">$780,100</td>
                        <td data-label="PRECIO DE CONTADO">$780,100</td>
                        <td data-label="PRECIO FINANCIADO *">$780,100</td>
                        <td data-label="PRECIO DE LEASING *">$780,100</td>
                    </tr>
                </tbody>
            </table>
        </div>
