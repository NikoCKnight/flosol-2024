    ...
    <div class="container mt-5 text-center">
        ...
        <div class="row" id="gallery">
            ...
            <div class="col-md-4 mb-4">
                <img src="../imgs-2025/galeria/galeria-<?php echo $i; ?>.avif" class="img-fluid rounded shadow" data-bs-toggle="modal" data-bs-target="#fullScreenGallery" data-bs-slide-to="<?php echo $i - 1; ?>" alt="Imagen <?php echo $i; ?>">
            </div>
            <?php endfor; ?>
            <div class="col-md-4 mb-4">
                    ...
                    <div class="modal-body">
                        <div id="carouselFullGallery" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item <?php echo $i === 1 ? 'active' : ''; ?>">
                                    <img src="../imgs-2025/galeria/galeria-<?php echo $i; ?>.avif" class="d-block w-100" alt="Imagen <?php echo $i; ?>">
                                </div>
                                <?php endfor; ?>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 d-flex justify-content-center thumbnail-wrapper">
                                <?php for($i = 1; $i <= 14; $i++): ?>
                                <img src="../imgs-2025/galeria/galeria-<?php echo $i; ?>.avif" data-bs-target="#carouselFullGallery" data-bs-slide-to="<?php echo $i - 1; ?>" class="img-fluid img-thumbnail mx-2" alt="Imagen <?php echo $i; ?>">
                                <?php endfor; ?>
                            </div>
                        </div>
                    </div>
