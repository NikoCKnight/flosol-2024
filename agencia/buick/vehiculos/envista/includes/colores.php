...
<div class="tab-content" id="pills-tabContent">
    <div class="tab-pane fade show active" id="sport-touring" role="tabpanel" aria-labelledby="sport-touring-tab">
        <div class="container text-center" style="margin-bottom: 20vh;">
            <img id="mainImage-sport" src="imgs-2025/colores/sport-t/summit-white.avif" class="img-fluid mb-2" alt="Imagen grande" style="max-width: 100%; height: auto; max-height: 500px;">
            <h3 class="text-muted" id="imageTitle-sport" style="font-size: 20px;">SUMMIT WHITE</h3>

            <div class="row justify-content-center">
                <div class="col-auto p-2">
                    <img src="<?php echo BASE_URL; ?>agencia/colores/summit.webp" class="img-thumbnail rounded-circle img-select" alt="Rojo" onclick="changeImage('imgs-2025/colores/sport-t/summit-white.avif', 'SUMMIT WHITE', 'sport')" style="width: 50px; height: 50px;">
                </div>
                <div class="col-auto p-2">
                    <img src="<?php echo BASE_URL; ?>agencia/colores/black-meet.jpg" class="img-thumbnail rounded-circle img-select" alt="Acero" onclick="changeImage('imgs-2025/colores/sport-t/black-meet.avif', 'BLACK MEET KETTLE', 'sport')" style="width: 50px; height: 50px;">
                </div>
                <div class="col-auto p-2">
                    <img src="<?php echo BASE_URL; ?>agencia/colores/jinx.jpg" class="img-thumbnail rounded-circle img-select" alt="Blanco" onclick="changeImage('imgs-2025/colores/sport-t/jinx.avif', 'JINX METALIC', 'sport')" style="width: 50px; height: 50px;">
                </div>
                <div class="col-auto p-2">
                    <img src="<?php echo BASE_URL; ?>agencia/colores/cosmonaut.png" class="img-thumbnail rounded-circle img-select" alt="Blanco" onclick="changeImage('imgs-2025/colores/sport-t/cosmonaut.avif', 'COSMONAUT METALIC', 'sport')" style="width: 50px; height: 50px;">
                </div>
                <div class="col-auto p-2">
                    <img src="<?php echo BASE_URL; ?>agencia/colores/sharkskin.png" class="img-thumbnail rounded-circle img-select" alt="Blanco" onclick="changeImage('imgs-2025/colores/sport-t/sharkskin.avif', 'SHARKSKIN METALIC', 'sport')" style="width: 50px; height: 50px;">
                </div>
                <div class="col-auto p-2">
                    <img src="<?php echo BASE_URL; ?>agencia/colores/marina.png" class="img-thumbnail rounded-circle img-select" alt="Blanco" onclick="changeImage('imgs-2025/colores/sport-t/marina.avif', 'MARINA METALIC', 'sport')" style="width: 50px; height: 50px;">
                </div>
            </div>
        </div>
    </div>
