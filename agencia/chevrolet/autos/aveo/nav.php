    ...
    <div class="container-fluid mt-3">
        <div class="row align-items-center text-center text-md-start">
            <div class="col-12 col-md-6 d-flex align-items-center justify-content-center justify-content-md-start">
                <span class="car-name">Aveo Sedán<span class="year-badge">2024</span></span>
            </div>
            <div class="col-12 col-md-6">
                <ul class="nav nav-tabs justify-content-center justify-content-md-end nav-tabs-custom">
                    <li class="nav-item nav-iteme">
                        <a class="nav-link <?php echo $activePage == 'descripcion' ? 'active' : ''; ?>" href="aveo.php">Descripción</a>
                    </li>
                    <li class="nav-item nav-iteme">
