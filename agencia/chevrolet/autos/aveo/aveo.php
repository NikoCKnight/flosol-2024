...
<body>
    <div class="position-relative">
        <img src="imgs/aveo.avif" class="img-fluid w-100" style="max-height: 70vh; object-fit: cover; margin-top: 5rem;" alt="Chevrolet Aveo">
        <div class="position-absolute top-50 start-50 translate-middle text-center">
            <h1 class="fw-bold text-white">Chevrolet Aveo</h1>
        </div>
    </div>
